...
VALUES ('statement_recon','sweep','scripts/u296-statement-recon.py','10 6 * * *',
        'SELECT max(finished_at) FROM ops.pipeline_runs WHERE name=''statement_recon'' AND status=''ok''',26,
